document.title = "Unicorns talking politics!";
...
var player1 = new Player((canvas.width / 2) - (120 / 2),
  (canvas.height / 2) - (219 / 2), 120, 219, "hoverJ.png", null, "image");
...
function Background() {
  ...
  this.renderSun = function() {
    ...
    context.save();
    var gapHeight = (sunRadius / 10);

    context.rect(0, 0, canvas.width, quarterY);

    for (var i = 0; i < 11; i = i + 2) {
      context.rect(0, quarterY + (i * gapHeight), canvas.width, gapHeight);
    }
    context.clip();

    context.beginPath();
    context.arc(middelX, quarterY, sunRadius, 0, twoPi);
